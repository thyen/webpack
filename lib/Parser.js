...
const AsyncSequencialHook = require("tapable").AsyncSequencialHook;
const AsyncSequencialBailHook = require("tapable").AsyncSequencialBailHook;
const AsyncWaterfallHook = require("tapable").AsyncWaterfallHook;
